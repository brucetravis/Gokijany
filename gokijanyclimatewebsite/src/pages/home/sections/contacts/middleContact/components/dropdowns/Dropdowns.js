  ...
  return (
    <div className="contact-dropdowns">
      <div className="contact-dropdown">
        ...
        {isOpen1 && (
          <div className="ml-4">
            ...
            as our Volunteers can see where ther have been planted
          </div>
        )}
      </div>
      <div className="contact-dropdown">
      ...
      <div className="contact-dropdown">
        ...
        {isOpen4 && (
          <div>
            We are working on partnering with establishments where you will be
            reedeming your points which have been converted into the crypto
            coin, "Goshilingy"
          </div>
        )}
      </div>
      ...
      <div className="contact-dropdown">
        ...
        {isOpen5 && (
          <div>
            We are partnering with other organizations which can offer job
            opportunities for our volunteers. Once It is finalized you will be
            informed.
          </div>
        )}
      </div>
